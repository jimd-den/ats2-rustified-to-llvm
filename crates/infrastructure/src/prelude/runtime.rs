//! # The Dynamic Prelude — ambient functions, templates and datatypes
//!
//! *Literate note.*  Declarations of standard ATS functions, print utilities,
//! collections (list0, option0, stream_con), array pointers, and memory operations.
